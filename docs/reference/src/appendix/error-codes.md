...
| 步骤 | 做法 |
|---|---|
| **码的来源** | [`src/libraries/z42c.core/src/DiagnosticCodes.z42`](../../../../src/libraries/z42c.core/src/DiagnosticCodes.z42) 的 110 个码常量，**加上**语义层 / 语法层用**字面量**直接发的码（`"E0449"`–`"E0481"` 一族、`"W0700"`、`"I0466"`）—— 后者不在常量文件里，只能扫源码字面量才找得到 |
