...
11. 0.4.0版本：1.repl 2.playground 3.toolchain：z42b 4.runtime改进：1)component 2)host/hostrun/main统一，不同平台共享简化 5.不同平台的测试流程构建 6.z42 bench和流程完善应用 7.z42c基础库入标准库libraries抽象封装：metadata，ir等 