...
> **相关**: [GC 调参与 safepoint](gc-tuning-and-safepoint.md) · [GC TLAB](gc-tlab-chunk-exclusive.md) ｜ **对齐**: 2026-09-16
...
见 [gc-tuning-and-safepoint.md「minor 位与 major epoch 同字节分治」](gc-tuning-and-safepoint.md)。要点：major 标记 =
