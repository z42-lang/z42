...
- **对外文档**（面向语言用户 / 潜在贡献者 / 公开发布）：**英文**
  - 例：[`features.md`](features.md), [`design/philosophy.md`](design/philosophy.md), [`design/language/language-overview.md`](design/language/language-overview.md), [`design/language/interop.md`](design/language/interop.md), [`design/runtime/hot-reload.md`](internals/src/runtime/hot-reload.md), [`design/runtime/execution-model.md`](internals/src/runtime/execution-model.md), [`design/language/object-protocol.md`](design/language/object-protocol.md), [`README.md`](../README.md)（仓库根）
