...
- **R4** — 编译期 attribute 校验：位置 + 签名（E0911/E0912/E0915）**已由
  ...
  `z42c.semantics/src/DeclEnforcer.z42` 落地**（2026-09-11）；**实参语义（E0913/E0914/E0917）由
  [complete-test-attr-arg-checks](../../spec/archive/2026-09-11-complete-test-attr-arg-checks/) 补齐**
  （2026-09-11）；`[TestCase(args)]` 仍未实现（parser 不识别）
...
`DeclEnforcer._passTestAttrEnforce` 在符号收集期强制（E0911/E0912/E0915）；实参语义由同 pass
（E0914/E0917）与相邻的 `_passTestAttrSemantic`（E0913，需符号表）强制。
...
| R4 | [compiler-validate-test-attributes](../../spec/archive/2026-04-30-compiler-validate-test-attributes/) | ⚠️ 原 C# 实现随编译器退休丢失、未移植；**2026-09-11 由 [enforce-test-attr-placement](../../spec/archive/2026-09-11-enforce-test-attr-placement/) 在 z42c 重新落地**（E0911/E0912/E0915；实参语义 E0913/E0914/E0917 随 complete-test-attr-arg-checks 补齐）| — |
