...
|----|---------|----------|------|------|
| ~~z42.compression~~ | ~~`System.IO.Compression`~~ | ~~`flate2` / `zstd`~~ | ~~L2~~ | **✅ 已落地 2026-05-24** add-z42-compression — Gzip / Zlib / Deflate / Zstd + Tar / Zip Read。首个 stdlib native 走出 z42vm（cdylib + dlopen via `native::ext` loader），详 [compression.md](compression.md) + [native-ext-loader.md](../../internals/src/runtime/native-ext-loader.md) |
