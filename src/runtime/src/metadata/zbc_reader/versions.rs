...
// PROBE probe-verbump-current (2026-09-02): nominal bump 36→37, no format change,
// to re-verify two-generation self-host converges on current origin/main. Not merged.
...
// unchanged; the bump triggers ci-bootstrap's version-diff two-gen self-host.
// PROBE probe-verbump-current (2026-09-02): nominal bump 41→42, no format change. Not merged.
